...
<div class="slider">
    <div class="owl-carousel owl-theme slide-adv">
        <?php foreach ($options['slider'] as $val) : ?>
        <div class="item">
        ...
        <div class="container">
            <div class="owl-carousel owl-theme custom_slider">
                ...
                <div class="item">
                    ...
                    <h5 class="heading"><?php echo $val['title']?> <span>Đến từ <?php echo $val['url']?></span> </h5>
                    <div class="cus_thumb">
                        <img src="<?php echo $val['image']?>" alt="<?php echo $val['title']?>">
                    </div>
                </div>
...
<?php endif;?>
    <!-- end custom_home -->
<?php if($options['expert']):?>
	<div class="expert_home">
        <div class="container">
            <div class="sh_title">
                <h4><?php echo $options['title_expert']?></h4>
                <p><?php echo $options['desc_expert']?></p>
                <span class="b_after"><i class="fas fa-chess-queen"></i></span>
            </div>
            <div class="ex_carou">
                <div class="owl-carousel owl-theme expert_slider">
                	<?php foreach ($options['expert'] as $val) : ?>
                    <div class="item">
                        <div class="row">
...
?>
    <div class="post_news">
        <div class="container">
            <div class="sh_title">
                <h4>Latest Posts</h4>
                <p>Luôn cập nhật các thông tin hữu ích về chăm sóc sắc đẹp, điều trị các khuyết điểm và các dịch vụ tốt nhất từ chúng tôi .</p>
                <span class="b_after"><i class="fas fa-chess-queen"></i></span>
            </div>
            <div class="row">
            	 <?php
                ...
                <div class="col-lg-6 col-xl-6">
                    <div class="post_main">
                        ...
                        <div class="post_title">
                            ...
                            <span class="date">Ngày <?php get_the_date('d-m-Y')?></span>
